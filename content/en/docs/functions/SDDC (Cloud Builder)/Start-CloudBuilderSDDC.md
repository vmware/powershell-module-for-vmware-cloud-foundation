---
title: "Start-CloudBuilderSDDC"
weight: 5
description: >
    Starts a Management Domain deployment task
---

## Syntax
``` powershell
Start-CloudBuilderSDDC -json <json_file>
```
...
```
Starts a Management Domain deployment task using the JSON


## Sample JSON
### VMware Cloud Foundation v4.0.0
