...
``` shell
git remote add upstream https://github.com/vmware/powershell-module-for-vmware-cloud-foundation
...
When your branch gets out of sync with the `powervcf/main` branch, use the following to update:
